...
class InputExample(object):
    ...
    def __init__(self, guid, text, label, seq_lens):
        self.guid = guid
        self.text = text
        self.label = label
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, input_mask, label_ids, seq_lens):
        ...
        with open(data_path, 'r', encoding='utf-8') as f:
            ...
            for line in f:
                if '\n' == line:
                    ...
                    examples.append(InputExample(guid=guid, text=text, label=label, seq_lens=len(text)))
                    text = ''
                    label = []
                    count += 1
                else:
